...
public class BorrowServiceTest {
    ...
    void setup() {
        ...
        userService.addUser(new User("u1"));
        user = userService.getUserById("u1");
    }
    ...
    void testBorrowBook() {
        ...
        boolean success = borrowService.borrowBook(user, "12345");
        assertTrue(success);
    ...
    void testReturnBook() {
        ...
        borrowService.borrowBook(user, "12345");
    ...
    void testOverdueDetection() {
        ...
        borrowService.borrowBook(user, "99999");
    ...
    void testBorrowBookFail() {
        ...
        assertFalse(borrowService.borrowBook(user, "99999"));
    }
